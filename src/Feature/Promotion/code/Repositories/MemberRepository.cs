...
namespace Acme.Feature.Promotion.Repositories
{
    public class MemberRepository
    {
        ...
        public RegisterFormFFNumber getRegisterFormFFNumber(Item promoSiteSettings)
        {
            var viewModel = new RegisterFormFFNumber();
            viewModel.ControlBase = new PageControlBase();
        ...
        public RegisterFormEmailAddress getRegisterFormEmailAddress(Item promoSiteSettings)
        {
            var viewModel = new RegisterFormEmailAddress();
            viewModel.ControlBase = new PageControlBase();
        ...
        public String getCountryDefault(Item promoSiteSettings)
        {
            String temp = promoSiteSettings.Fields[FieldNames.CountryDefault].ToString();
            if (String.IsNullOrWhiteSpace(temp))temp = Defaults.Country; 
        ...
        public String getStateDefault(Item promoSiteSettings, String country)
        {
            String temp = promoSiteSettings.Fields[FieldNames.StateDefault].ToString();
            if (String.IsNullOrWhiteSpace(temp))
            {
                if (country == Defaults.Country) temp = Defaults.State;
            } 
            return temp;
